...
{
    public class IOHelper : WaveStream
    {
        ...
        public static WaveFormat NormalPcmMono16_Format
        {
            get
            {
                return new WaveFormat(44100, 1);
            }
        }
        public static long NormalPcmMono16_HeadLength
        {
            get
            {
                return 46;
